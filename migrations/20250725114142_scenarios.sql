...
-- шаги терапии
insert into scenario_steps (scenario_id, step_order, content, is_final, next_step, next_delay) values
...
Если вдруг будут какие-то реакции со стороны желудка - сразу напишите врачу.', false, 13, '5 day'),
        (4, 9, 'Понятно. Тогда ожидаем. Надеюсь, ожидание будет недолгим😸', false, null, null),
