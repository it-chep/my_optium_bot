...
values ('init', 'ИНИТ, Сценарий для врача, когда врач исполняет команду /init', false),                      -- 1
       ('metrics', 'Метрики, ознакомление со сценарием метрики, запускается 1 раз', false),                  -- 2
       ('non', '- Не используется', false),                                                                  -- 3
       ...
       ('recommendation',
        ...
        false),                                                                                              -- 6
       ('non2', '- Не используется', false),                                                                 -- 7
       ('information', 'Информация, повторяющийся сценарий, дефолт раз в неделю', false),                    -- 8
...
values (1, 1, 'Укажите Фамилию Имя клиента', false),
...
values (8, 1, 'Здравствуйте, {{.FirstName}} !
...
Итак, первый пост.',
        false, 3, '5 seconds'),
       (8, 2, 'Здравствуйте, {{.FirstName}} ! У меня для вас очередная полезная и интересная информация, почитайте!

👍Ставьте под постами лайки, если информация была полезной! 👍',
        false, 3, '1 second'),
       (8, 3, '{{.InformationPost}}', false, 2, '4 days'),
       -- todo тут должно от sheduled_time зависеть
       (8, 4, 'Отправляю вам информацию о том, как можно еще укрепить свое здоровье.', false, 3, null);
-- ИНФОРМАЦИЯ

-- ПОТЕРЯШКА
insert into scenario_steps (scenario_id, step_order, content, is_final, next_step, next_delay, delay_from_patient)
values (9, 1, 'Здравствуйте, {{.FirstName}}! Давно не общались с вами.

Скажите, пожалуйста, на каком этапе сейчас находитесь?', false, null, null, null),
...
{{.MetricsLink}}', true, null, null, null),
...
@my_Optimum', true, null, null, null),
       (9, 5, 'Введите, пожалуйста, дату в формате ДД.ММ.ГГГГ', false, 6, '10 days', false),
...
Я сообщу вашему врачу, он напишет вам.',
        true, null, null, null),
       (9, 15, 'Опишите, пожалуйста, причину.

Мы еe проанализируем!',
        true, null, null, null);

insert into step_buttons (scenario, step, button_text, next_step_order)
values (9, 1, 'Я в процессе!', 2),
       (9, 1, 'Я возвращаюсь в процесс', 3),
       (9, 1, 'Пока не сдал конрольные анализы', 4),
       (9, 1, 'Вернусь примерно к дате...', 5),
       (9, 1, 'Остановил работу', 9),
       (9, 7, 'Да', 8),
       (9, 7, 'Вернусь примерно к дате...', 5),
       (9, 7, 'Не планирую продолжать', 9),
       (9, 9, 'Достиг цели', 10),
       (9, 9, 'Нет времени', 11),
       (9, 9, 'Пока нет финансов на это', 12),
       (9, 9, 'Были побочные реакции', 13),
       (9, 9, 'Не получил результата', 14),
       (9, 9, 'Другое', 15)
;
-- ПОТЕРЯШКА
...
Объем обследования, добавление новых анализов и направлений работы вы можете обсудить с вашим врачом.', false, 3,
        '1 second'),
       (10, 3,
        'Заполните ещё, пожалуйста, метрики сегодня. Врачу важно видеть их, чтобы оценить динамику и понять  на что сделать акцент, какие анализы проконтролировать.',
        false, 4, '2 seconds'),
