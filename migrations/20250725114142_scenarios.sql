...
👍Ставьте под постами лайки, если информация была полезной! 👍',
        false, 2, '1 second'),
       (8, 2, '{{.InformationPost}}', false, null, null),
       -- todo тут должно от sheduled_time зависеть
       (8, 3, 'Отправляю вам информацию о том, как можно еще укрепить свое здоровье.', false, null, null),
       (8, 4, 'Текст поста по теме Подготовка к новому этапу', false, null, null);
-- ИНФОРМАЦИЯ
...
Объем обследования, добавление новых анализов и направлений работы вы можете обсудить с вашим врачом.', false, 4,
        '1 second'),
       (10, 3,
...
Поделитесь, как проходит терапия? Не замечали нежелательные реакции?', false, null, null),
       ...
       (4, 12, '🔥Пожалуйста, сообщите вашему врачу об этих реакциях. Он расскажет вам, что можно сделать. Я ему сейчас тоже сообщу.', false, 16, '7 day'),
